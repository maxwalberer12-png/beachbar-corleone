      ...
      >
        ...
        >
          <h1 className={`w-full text-center font-serif font-black tracking-tight text-white uppercase leading-[0.98] drop-shadow-[0_4px_24px_rgba(0,0,0,0.9)] animate-hero-title ${
            ...
            <span className="block text-white text-center w-full whitespace-pre-line">{t.titleStart}</span>
            <span className="block text-amber-400 sm:animate-liquid-gradient text-center w-full whitespace-pre-line drop-shadow-md">
              {t.titleAccent}
            </span>
